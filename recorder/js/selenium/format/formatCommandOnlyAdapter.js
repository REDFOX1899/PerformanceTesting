 ...
 * @param suite_name The name of test suite, if any. It may be used to embed title into the source.
 */
function format(testCase, suite_name) {
    var result = "";
    var header = "";
    var footer = "";
    this.commandCharIndex = 0;
    if (this.formatHeader) {
        header = formatHeader(testCase, suite_name);
    }
    result += header;
